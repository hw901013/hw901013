...
namespace LAB.ZH.SNMP.WCF.B
{
    public class Info
    {
        ...
        /// 服务状态
        /// </summary>
        private static string _ServerStatic = "未开启";

        public string ServerStatic
        {
            get { return Info._ServerStatic; }
            set { Info._ServerStatic = value; }
        }
        ...
        ///数据库状态
        /// </summary>
        static string _DBStatic = "9";

        public string DBStatic
        {
            get { return Info._DBStatic; }
            set { Info._DBStatic = value; }
        }

        /// <summary>
        /// 错误信息
        /// </summary>
        static Dictionary<string, string> _Errorinfo = new Dictionary<string, string>();

        public Dictionary<string, string> Errorinfo
        {
            get { return Info._Errorinfo; }
            set { Info._Errorinfo = value; }
        }


        static Dictionary<string, string> _alter = new Dictionary<string, string>();

        public  Dictionary<string, string> Alter
        {
            get { return Info._alter; }
            set { Info._alter = value; }
        }
